...
const originalHeroImages: HeroImage[] = [
  ...
  {
    id: 'hero-image-04',
    image: '/assets/details/detail-pink.webp',
    width: 1080,
    height: 1350,
  ...
  {
    id: 'hero-image-05',
    image: '/assets/products/product-sweet.webp',
    width: 1080,
    height: 1350,
  ...
  {
    id: 'hero-image-06',
    image: '/assets/products/product-color.webp',
    width: 1080,
    height: 1350,
  ...
  {
    id: 'hero-image-07',
    image: '/assets/details/detail-night.webp',
    width: 1080,
    height: 1350,
  ...
  {
    id: 'hero-image-08',
    image: '/assets/products/product-night.webp',
    width: 1080,
    height: 1350,
  ...
  {
    id: 'hero-image-09',
    image: '/assets/hero/hero-forest.webp',
    width: 1080,
    height: 1350,
  ...
  {
    id: 'hero-image-10',
    image: '/assets/products/product-blue.webp',
    width: 1080,
    height: 1350,
  ...
  {
    id: 'hero-image-11',
    image: '/assets/products/product-purple.webp',
    width: 1080,
    height: 1350,
    alt: '紫色花朵場景裡的手作萌粒手機鍊',
  },
...
const instagramCarouselImages: HeroImage[] = Array.from({ length: 28 }, (_, index) => {
  ...
  return {
    ...
    image: `/assets/instagram/post-${postNumber}.webp`,
    width,
    height,
